...
function App() {
  ...
  const [newUsersNumber, setNewUsersNumber] =
    useState<AppState["newUsersNumber"]>(0);
  ...
  return (
    <div className="App" ref={divRef}>
      ...
      {uiState.showNotification && (
        <div
          className={`notification ${uiState.isDarkMode ? "dark" : "light"}`}
        >
          User <strong>{uiState.newUserName}</strong> has been created
          successfully!
        </div>
      )}
      ...
      <div className="content">
        {!isLoggedIn ? (
          ...
          <Update
            ...
            onCancel={() => setEditingUser(null)} // Cancela la edición
          />
        ) : (
          <>
